...
object XDecode extends DecodeConstants {
    ...
    val RV32I: Array[(BitPat, List[BitPat])] = Array(
        ...
        JALR    -> List(N,  RET_SRC_C,  MEM_WR_N,   MEM_RD_N,   MEM_TYP_XX, BitPat(ADD),  ALU_SRC_B,  IMM_I,  IMM_SE, REG_WR_Y),
        JAL     -> List(N,  RET_SRC_C,  MEM_WR_N,   MEM_RD_N,   MEM_TYP_XX, ALU_XXX,      ALU_SRC_B,  IMM_J,  IMM_ZE, REG_WR_Y),
